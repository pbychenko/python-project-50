...
def test_big_yml_stylish():
    print(os.getcwd())
    file1_path = os.path.join(os.getcwd(), 'tests', 'fixtures', 'yaml', 'file31.yml')
    file2_path = os.path.join(os.getcwd(), 'tests', 'fixtures', 'yaml', 'file32.yml')
    result_path = os.path.join(os.getcwd(), 'tests', 'fixtures', 'results', 'result_stylish1.txt')
    result_data = open(result_path, 'r').read()
    print('my result', generate_diff(file1_path, file2_path))
